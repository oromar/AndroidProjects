...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new FecthWeatherData().execute(NetworkUtils.buildUrl(SunshinePreferences.getPreferredWeatherLocation(this)));
    }
    ...
    private class FecthWeatherData extends AsyncTask<URL, Void, String> {

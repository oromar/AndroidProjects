...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mLoadingIndicatiorProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingIndicatiorProgressBar = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    }
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            mLoadingIndicatiorProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            mLoadingIndicatiorProgressBar.setVisibility(View.INVISIBLE);
